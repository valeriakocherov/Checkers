...
public class MusicService extends Service implements
    ...
    private ArrayList<Songs> valuesList; //songs List
    ...
    public void getSongs() {
        ...
        if (songs != null && songs.moveToFirst()) {
            ...
            while (songs.moveToNext()) {
                ...
                song = new Songs(longSongID, currentTitle);
                valuesList.add(song);
            }
        }
    }
    ...
    public ArrayList<Songs> getValuesList() {
    ...
    public void playSong() {
        ...
        Songs songToPlay = valuesList.get(songPosn);
